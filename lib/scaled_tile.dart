...
class ScaledTile extends StaggeredGridTile {
  ...
  ScaledTile.extent(
    ...
    double mainAxisExtent,
      Widget child,
  ) : super.extent(child: child, crossAxisCellCount: crossAxisCellCount, mainAxisExtent: mainAxisExtent);
  ...
  ScaledTile.count(
    ...
    num mainAxisCellCount,
      Widget child,
  ) : super.count(child: child, crossAxisCellCount: crossAxisCellCount, mainAxisCellCount: mainAxisCellCount);
}
